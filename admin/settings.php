...
if(isset($_POST['form10'])) {
	...
	//$statement->execute(array($_POST['before_body']));
    $success_message = 'Body Script is updated successfully.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Icon</a></li>
                     ...
                     <!--   <li><a href="#tab_9" data-toggle="tab">Payment Settings</a></li> -->
                        <li><a href="#tab_10" data-toggle="tab">Tawk.to Body Scripts</a></li> 
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Update Icon</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">COD - Business Email </label> 
                                            <div class="col-sm-5">
                                    ...
                                    <!--   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">COD / Details </label>
                                            <div class="col-sm-5">
