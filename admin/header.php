	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Zamboanga Barter Online Market</span>
			</a>
    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'settings.php') ) {echo 'active';} ?>">
			          <a href="settings.php">
			            <i class="fa fa-envelope"></i> <span>Website Settings</span>
			          </a>
			        </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product.php">
                            <i class="fa fa-eye"></i> <span>View / Add Products</span>
                        </a>
                    </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="order.php">
                            <i class="fa fa-edit"></i> <span>Orders Management</span>
                        </a>
                    </li>
                     ...
                     <li class="treeview <?php if( ($cur_page == 'slider.php') ) {echo 'active';} ?>">
			          <a href="slider.php">
			            <i class="fa fa-link"></i> <span>Slider</span>
			          </a>
			        </li>
			       ...
			       <!-- <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'page.php') ) {echo 'active';} ?>">
			          <a href="page.php">
			            <i class="fa fa-clone"></i> <span>Page</span>
			          </a>
			        </li>
