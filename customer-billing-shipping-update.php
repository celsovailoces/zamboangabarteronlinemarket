            ...
            <div class="col-md-12">
			   ...
			   <center>
                    ...
                    if($error_message != '') {
						...
						echo $error_message = 'Delivery Address Updated unsuccessfull.';
                    }
                    if($success_message != '') {
                      // echo "<div class='success' style='padding: 10px;background:#f1f1f1;margin-bottom:20px;'>".$success_message."</div>";
					   echo $success_message = 'Delivery Address Updated successfully.';
                    }
                    ?>
                    <form action="" method="post">
                       ...
                       <!-- <div class="row">
                            ...
                            <div class="col-md-6">
                                <h3><!--<?php echo LANG_VALUE_87; ?> -->Delivery Address</h3>
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_102; ?></label>
