...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Delivery Fee is updated successfully.';
  ...
  <div class="row">
   <div class="col-md-12"> -->
      ...
      <div class="box box-info">
        ...
        <div class="box-body table-responsive">  <h4 style="background: #dd4b39;color:#fff;padding:10px 350px;">NOTE! Select The Amount Of The Delivery Fee.</h4>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"></label>
                            <div class="col-sm-6">
                              <table>  <button type="submit" class="btn btn-success pull-left" name="form2">Update</button> </table>
                            </div>
                        </div>
                    </div>
                </div>
