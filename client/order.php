            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
							...
							<!--<b>Phone:</b> <?php echo $row['customer_phone']; ?><br><br> -->
							<b>Alternative CP Number:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		<b>Payment Method:</b><!--<span style="color:red;"><b>Cash On Delivery</b>--><?php echo '<span style="color:red;"><b>Cash On Delivery</b></span>'; ?><br>
                        		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                        		<!--<b>Landscape:</b> <br><?php echo $row['bank_transaction_info']; ?><br>-->
                        	<?php endif; ?>
                        </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure want to delete this item<3?
            </div>
            <div class="modal-footer">
