			...
			<div class="col-md-12">
                <div class="breadcrumb mb_30">
                    <ul>
                        ...
                        <li>></li>
						<!--<li><a href="<?php echo BASE_URL.'product-category.php?id='.$fcat_id.'&type=end1-category' ?>"><?php echo $fcat_name; ?></a></li> -->
                        <li>></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3><!--<?php echo LANG_VALUE_156; ?>-->See all Related Products Here</h3>
                </div>
            </div>
        </div>
        <div class="row">
