...
<div class="top">
	...
	<!--LOGO TEXT BANNER /Zamboanga Barter | Online Market/ MEN, WOMEN, KIDS, ABOUT, FAQ, CONTACT, -->
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container">
					<div class="menu">
						...
						<!--<a href="index.php"><img src="assets/uploads/logo.png" alt="logo image"></a> Z-Barter | Online Market -->
