...
<!--<h3>//ADMIN:celzvailoces@gmail.com/celsovailoces2020@gmail.com PASS:1234 </h3> -->
<?php
...
?>
 <!--//login form// <h3>//CUSTOMER LOGIN:celzvailoces@gmail.com PASS:1234</h3> -->
<?php
        ...
        if($total==0) {
            ...
            if( $row_password != md5($cust_password) ) {
                ...
                if($cust_status == 0) {
                   ...
                   // header("product-category.php: ".BASE_URL."product-category.php?id=1&type=top-category");
					header("location: dashboard.php?name"); //".BASE_URL.'logout.php'); 
                }
            }
