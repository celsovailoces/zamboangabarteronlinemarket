        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['customer'])): ?>
                    <p>
                        <a href="registration.php" class="btn btn-md btn-danger"><!--<?php echo LANG_VALUE_160; ?>-->Sign Up</a>
                    </p>
                <?php else: ?>
             ...
             <!--  <div class="billing-address">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h3 class="special"><!--<?php echo LANG_VALUE_162; ?>-->Delivery Address</h3>
                            <table class="table table-responsive table-bordered bill-address">
                                <tr>
                                    <td><?php echo LANG_VALUE_102; ?></td>
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    <label for=""><!--<?php echo LANG_VALUE_34; ?>-->Payment *</label>
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        <option value=""><?php echo LANG_VALUE_35; ?></option>
	                                     <!--   <option value="PayPal"><?php echo LANG_VALUE_36; ?></option> -->
	                                      <option value="Bank Deposit"><!--<?php echo LANG_VALUE_38; ?> --> Cash On Delivery</option>
	                                    </select>
	                                </div>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                       ...
                                       <div class="col-md-12 form-group"> 
                                            <label for=""><!--<?php echo LANG_VALUE_43; ?>-->Alternative Phone Number Input Below! <i class="fa fa-angle-double-down"></i></a></li></i></span></label><br>
                                          <!-- <?php
                                            $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                     ...
                                     <div class="col-md-12 form-group"> 
                                           &nbsp;&nbsp;&nbsp; <input type="submit" class="btn btn-primary" value="Proceed" name="form3">
                                        </div> 
                                    </form>
